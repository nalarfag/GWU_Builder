...
// Function to insert data to the table
        function Questionnaire_insert_sample() {
            ...
            $Insert_queries = array(
                ...
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country) values(1,'Monisha',True,'00:10:00','2014-05-03','120.32.255.03','Washington','USA')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)  values(2,'Nada',True, '00:12:00','2014-04-15','120.32.255.05','Washington','USA')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)   values(3,null,True, '00:09:00','2014-07-12','120.36.255.17','Virginia','USA')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)   values(4,null,False, '00:20:00','2014-08-15','120.36.255.17','San Fransisco','USA')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)  values(5,'null',True, '00:19:00','2014-09-11','120.32.255.22','Delhi','India')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)   values(8,null,True, '00:09:00','2013-05-12','130.45.567.89','Beijing','China')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)   values(9,'Sunny',True, '00:12:00','2013-08-24','176.34.56.234','Las Vegas','USA')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)  values(10,'Iswarya',True, '00:20:00','2014-01-31','135.234.34.56','Bangalore','India')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)  values(11,null,False,'00:07:00','2013-06-18','234.456.34.67','Arizona','USA')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)  values(6,'neeraj',True, '00:19:00','2014-08-08','120.32.255.03','Dubai','Emirates')",
                "insert into gwu_session (SessionID,UserName,SurveyCompleted, Duration, SurveyTakenDate, IP, City, Country)  values(7,'chandan',True, '00:18:00','2014-01-05','120.32.255.05','San Diego','USA')",
