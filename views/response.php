...
function Response_questions($atts)
{
    ...
    else
    {
        ...
        elseif($question->get_AnsType()=='Multiple Choice, Single Value')
        {
            ...
            $output .='<br/><br/><input type="submit" /></form>';
        ...
        else
        {
            ...
            $output .= '<td>' . $Answerchoices[11]->get_AnsValue() . ' </td></tr></table><br/><br/><input type="submit" /></form>';
        }
